...
<head>
<meta charset="UTF-8">
<title>Sample Web - Caf&eacute; Order Confirmation</title>
...
if (class_exists('mysqli')) {
	...
	print "<br>Error: Class 'mysqli' not exist, no 'mysqli' extension installed!<br>";
}
?>
...
?>
	...
	<div id="Copyright" class="center">
		<h5>&copy; 2020, Amazon Web Services, Inc. with some modification.</h5>
	</div>
